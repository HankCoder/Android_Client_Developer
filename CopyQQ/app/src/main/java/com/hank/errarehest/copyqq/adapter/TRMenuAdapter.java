package com.hank.errarehest.copyqq.adapter;
...
import com.hank.errarehest.copyqq.entity.MenuItemLocal;
...
public class TRMenuAdapter extends RecyclerView.Adapter<TRMenuAdapter.TRMViewHolder> {
    ...
    private List<MenuItemLocal> menuItemList;
    private boolean showIcon;
    private TopRightMenu mTopRightMenu;
    private TopRightMenu.OnMenuItemClickListener onMenuItemClickListener;

    public TRMenuAdapter(Context context, TopRightMenu topRightMenu, List<MenuItemLocal> menuItemList, boolean show) {
    ...
    public void setData(List<MenuItemLocal> data){
        menuItemList = data;
    ...
    public void onBindViewHolder(TRMViewHolder holder, int position) {
        final MenuItemLocal menuItem = menuItemList.get(position);
        if (showIcon){
