package com.hank.errarehest.copyqq.activity.presenter;
...
import com.hank.errarehest.copyqq.adapter.TRMenuAdapter;
...
public class TopRightMenu {
     ...
     * @return
     */
    public TopRightMenu addMenuItem(MenuItemLocal item){
     ...
     * @return
     */
    public TopRightMenu addMenuList(List<MenuItemLocal> list){
